                          ...
                          ElevatedButton(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        DateFormat('EEE').format(yday4),
                                        style: TextStyle(color: Colors.black),
                                      ),
                                      Text(DateFormat('d MMM').format(yday4),
                                          style: TextStyle(color: Colors.black))
                                    ]),
                              )),
                          ElevatedButton(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        DateFormat('EEE').format(yday3),
                                        style: TextStyle(color: Colors.black),
                                      ),
                                      Text(DateFormat('d MMM').format(yday3),
                                          style: TextStyle(color: Colors.black))
                                    ]),
                              )),
                          ElevatedButton(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        DateFormat('EEE').format(yday2),
                                        style: TextStyle(color: Colors.black),
                                      ),
                                      Text(DateFormat('d MMM').format(yday2),
                                          style: TextStyle(color: Colors.black))
                                    ]),
                              )),
                          ElevatedButton(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      Text(
                                        DateFormat('EEE').format(yday1),
                                        style: TextStyle(color: Colors.black),
                                      ),
                                      Text(DateFormat('d MMM').format(yday1),
                                          style: TextStyle(color: Colors.black))
                                    ]),
                              )),
                          ElevatedButton(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(DateFormat('d MMM').format(today),
                                          style: TextStyle(color: Colors.black))
                                    ]),
                              ))
                        ],
